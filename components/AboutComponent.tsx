...
{/* <hr className="mt-8 mx-12 h-0.5 border-t-0 w-96 bg-gradient-to-r from-indigo-400 to-indigo-900 opacity-100 dark:opacity-50" /> */}
          <div className="flex font-semibold">
            <div className=" ml-16 mr-6 mt-10 text-4xl text-indigo-900"> Ahmad Issa <br></br> 
              ...
              Hey there, I'm Ahmad Issa – your friendly neighborhood computer science expert and all-around enthusiast! 🥳
              <br/><br/>
              ...
              <br/><br/>
              Some people might call me an extrovert, and they're absolutely right! I love meeting new people, making friends, and having a good time. I believe that my social skills are top-notch, and I thrive in group settings. Let's chat, laugh, and make some awesome memories together! 🗣️
              <br/><br/>
